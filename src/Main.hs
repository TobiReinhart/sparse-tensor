...
main = do 
    ...
    let ansatz8'' = shiftVarLabels (getHRank1 ansatz12'') ansatz8' 

    let ansatz4'' = shiftVarLabels (getHRank1 ansatz12'' + getHRank1 ansatz8'') ansatz4' 
    ...
    let eqn1Generic = eqn1G 2 3 5 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor

    let eqn2Generic = eqn2G 2 3 5 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor

    let eqn3Generic = eqn3G 2 3 5 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor

    let eqn1AGeneric = eqn1AG 2 3 4 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor generic8Ansatz

    let eqn1AaGeneric = eqn1AaG 2 3 4 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor generic9Ansatz 

    let eqn1AIGeneric = eqn1AIG 2 3 4 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor generic10_2Ansatz 

    let eqn2AGeneric = eqn2AG 2 3 4 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor generic9Ansatz 

    let eqn2AaGeneric = eqn2AaG 2 3 4 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor generic10_1Ansatz 

    let eqn2AIGeneric = eqn2AIG 2 3 4 7 11 13 map1Metric map2Metric map1Area map2Area generic11Ansatz 
    
    let eqn3AGeneric = eqn3AG 2 3 4 7 11 13 map1Metric map2Metric map1Area map2Area ZeroTensor generic10_2Ansatz 
    ...
    let tensL = AppendTList eqn1AGeneric $ AppendTList eqn1AaGeneric $ AppendTList eqn1AIGeneric $
