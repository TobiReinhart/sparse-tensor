...
module FlatTensorEquations (
    ...
    ansatzABCcDd ans18_3 = block1 &+ block2 &+ block3 
        where 
            ...
            block2 = tensorTrans5 (0,2) $ tensorTrans1 (1,3) $ aSymATens5 (1,3) $ contrATens3 (0,0) $ contrATens1 (2,0) $ contrATens3 (4,0) $ ans18_3 &* interEqn2 &* invEta
            block3 = tensorTrans1 (1,2) $ tensorTrans5 (0,2) block2  
