...
/* package HaskellTensor-0.1.0.0 */
#ifndef VERSION_HaskellTensor
#define VERSION_HaskellTensor "0.1.0.0"
#endif /* VERSION_HaskellTensor */
#ifndef MIN_VERSION_HaskellTensor
#define MIN_VERSION_HaskellTensor(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HaskellTensor */
...
#define CURRENT_COMPONENT_ID "HaskellTensor-0.1.0.0-1vunVB2Vrj1KV1boo6bPul-HaskellTensor"
