...
module GenericTensorEquations (
    ...
    eqn1AaGeneric ans5 ans9 ans10_1 ans11 area area_p area_I = block1 &+ block2 &+ block3 &+ block4 
        where 
            ...
            block3 = tensorTrans5 (0,1) $ mapTo6 (ansVarToAreaVar) $ contrATens1 (0,0) $ contrATens3 (0,1) $ ans5 &* interEqn2
    ...
    eqn2AaGeneric ans6 ans10_1 ans11 area area_p = block1 &+ block2 &+ block3 
        where 
            ...
            block3 = symATens5 (1,2) $ mapTo6 (ansVarToAreaVar) $ contrATens1 (0,0) $ contrATens2 (0,0) $ ans6 &* interEqn4
