...
module FlatTensorEquations (
    ...
    ansatzAIBJCK ans18 = block1 &+ block2 &+ block3
        where 
            block1 = aSymATens5 (0,1) $ contrATens1 (0,0) $ contrATens2 (0,0) $ contrATens3 (1,0) $ ans18 &* interEqn3 &* invEta 
    ...
    ansatzABCDJ ans18_2 = block1 &+ block2 &+ block3 &+ block4 
        where
            ...
            block2 = tensorTrans1 (0,3) block1
            block3 = tensorTrans1 (1,3) block1 
            block4 = symATens5 (0,1) $ contrATens2 (0,0) $ contrATens1 (3,0) $ contrATens3 (1,0) $ ans18_2 &* interEqn3 &* invEta
            
    ansatzABCcDd :: ATens 4 0 0 0 2 0 AnsVar -> ATens 4 0 0 0 4 0 AnsVar 
    ansatzABCcDd ans18_3 = block1 &+ block2 &+ block3 
        where 
            block1 = symATens1 (0,3) $ aSymATens5 (2,3) $ contrATens1 (0,0) $ contrATens3 (3,0) $ ans18_3 &* interArea &* invEta
            block2 = aSymATens5 (1,3) $ contrATens3 (0,0) $ contrATens1 (2,0) $ contrATens3 (4,0) ans18_3 &* interEqn2 &* invEta
            block3 = tensorTrans1 (2,3) $ tensorTrans5 (0,2) block2  
